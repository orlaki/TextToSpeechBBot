...
def handle_text(message):
    ...
    if user_rate_input_mode.get(user_id) == "awaiting_rate_input":
        try:
            ...
            if -100 <= rate_val <= 100:
                ...
                bot.send_message(message.chat.id, "❌ Qiime khaldan. Isku day mar kale:")
        except ValueError:
            bot.send_message(message.chat.id, "Tani ma aha lambarka saxda ah.")
        return
    ...
    if user_pitch_input_mode.get(user_id) == "awaiting_pitch_input":
        try:
            ...
            if -100 <= pitch_val <= 100:
                ...
                bot.send_message(message.chat.id, "❌ Pitch khaldan. Isku day mar kale:")
        except ValueError:
            bot.send_message(message.chat.id, "Tani ma aha lambarka saxda ah.")
        return
    ...
    try:
        ...
        custom_name = "@msspeechbot () – Microsoft Muuse Online (Natural) - Somali (Somalia) 8.mp3"
